...
<head>
    ...
    <title><?= $title; ?> | Aplikasi Persediaan Stok Barang</title>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Persediaan Stok Barang 2020 &bull; by <?= anchor('https://www.Septian.id', 'Septian.id'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
